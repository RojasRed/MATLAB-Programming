...
Example1 = cat(4,diff_1,diff_2,diff_3,diff_4); %Crear un Multidimensional Array representando un secuencia de imagenes, 
% con dimension maxima 4 para el maximo de imagenes
...
Example2 = cat(4,sub_1,sub_2,sub_3,sub_4);  %Crear un Multidimensional Array representando un secuencia de imagenes, 
% con dimension maxima 4 para el maximo de imagenes
